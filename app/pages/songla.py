...
<div class="col-12 align-items-center">
    ...
    <div id="uiCarousel" class="carousel has-dots is-draggable"><div class="carousel__viewport"><div class="carousel__track" style="transform: translate3d(170.801px, 0px, 0px) scale(1);">
        <div class="carousel__slide is-selected" data-index="0"><img data-lazy-src="/assets/imgs/songla/UI01.png" data-fancybox="/assets/imgs/songla/UI01.png" class="d-block w-100" alt="/assets/imgs/songla/UI01" src="/assets/imgs/songla/UI01.png"></div>
        <div class="carousel__slide" data-index="1" aria-hidden="true"><img data-lazy-src="/assets/imgs/songla/UI02.png" data-fancybox="/assets/imgs/songla/UI02.png" class="d-block w-100" alt="/assets/imgs/songla/UI02" src="/assets/imgs/songla/UI02.png"></div>
        <div class="carousel__slide" aria-hidden="true"><img data-lazy-src="/assets/imgs/songla/UI03.png" data-fancybox="/assets/imgs/songla/UI03.png" class="d-block w-100" alt="/assets/imgs/songla/UI03"></div>
        <div class="carousel__slide" data-index="3" aria-hidden="true" style="left: -2049.59px;"><img data-lazy-src="/assets/imgs/songla/UI04.png" data-fancybox="/assets/imgs/songla/UI04.png" class="d-block w-100" alt="/assets/imgs/songla/UI0ˋ" src="/assets/imgs/songla/UI04.png"></div>
        <!-- 更多的圖片 -->
    ...
    <script>
        const uiCarousel = new Carousel(document.querySelector("#uiCarousel"), {
            // 配置選項
            autoplay: true,
            autoplaySpeed: 3000, // 每張圖片展示 3000 毫秒，即 3 秒
            infinite: true
        });
    </script>
</div>
