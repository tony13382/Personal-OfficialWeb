  ...
  <CardContent>
    ...
    <div className="flex flex-col gap-4 mt-5">
      <div className="space-y-1">
        <Badge variant="outline" className="text-base -ms-1.5">客製化對話情境</Badge>
      ...
      <hr/>
      <div className="space-y-1">
        <Badge variant="outline" className="text-base -ms-1.5">聊天話題不間斷</Badge>
        <p className="text-gray-700 leading-relaxed">
      ...
      <hr/>
      <div className="space-y-1">
        <Badge variant="outline" className="text-base -ms-1.5">個人化智慧提醒</Badge>
        <p className="text-gray-700 leading-relaxed">
...
<Card>
  <CardContent>
    ...
    <div className="space-y-4">
      <IconBlock title="用戶輸入（鍵盤攔截）" icon="KeyboardIcon" />
      <IconBlock title="鍵盤利用 Web APIs 將文字傳送至 `MindReader Core`" icon="WebhooksLogoIcon" />
      <IconBlock title="`Line Bot` 抓取用戶 ID" icon="IdentificationBadgeIcon" />
      <IconBlock title="根據 ID 與文字進行轉換" icon="SparkleIcon" />
      <IconBlock title="傳送轉譯後文字" icon="TextboxIcon" />
      <IconBlock title="接收使用者以外的回饋文字" icon="ChatTeardropTextIcon" />
      <IconBlock title="`錄入資料`進行評分" icon="DatabaseIcon" />
    </div>
  </CardContent>
</Card>
