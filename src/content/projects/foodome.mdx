  ...
  <CardContent>
    ...
    <div className="space-y-6 mt-6">
      <div className="space-y-3">
        <Badge variant="secondary" className="text-base">1</Badge>
        <ImageWithLightbox
          src="/assets/imgs/projects/foodome/ui01.png"
          allowPop={true}
          client:load
        />
      ...
      <div className="space-y-3">
        <Badge variant="secondary" className="text-base">2</Badge>
        <ImageWithLightbox
          src="/assets/imgs/projects/foodome/ui02.png"
          allowPop={true}
          client:load
        />
        <p className="text-gray-700">
      ...
      <div className="space-y-3">
        <Badge variant="secondary" className="text-base">3</Badge>
        <ImageWithLightbox
          src="/assets/imgs/projects/foodome/ui03.png"
          allowPop={true}
          client:load
        />
        <p className="text-gray-700">
      ...
      <div className="space-y-3">
        <Badge variant="secondary" className="text-base">4</Badge>
        <ImageWithLightbox
          src="/assets/imgs/projects/foodome/ui04.png"
          allowPop={true}
          client:load
        />
        <p className="text-gray-700">
